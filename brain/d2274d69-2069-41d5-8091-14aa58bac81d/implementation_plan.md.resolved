...
> [!TIP]
> Kita bisa menambahkan fitur **Biometric Login** (Fingerprint/FaceID) setelah login pertama berhasil untuk meningkatkan kemudahan akses pengguna di masa depan.

> [!IMPORTANT]
> Apakah Anda setuju dengan palet warna dan tata letak pada mockup di atas? Jika ya, saya akan mulai menyiapkan struktur kodenya.
